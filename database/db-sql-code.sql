-- ORDER MATTERS - DO NOT REORDER THESE STATEMENTS
-- This file contains SQL commands to create the database schema for the CSE340 Week 1

-- Type: account_type
-- DROP TYPE IF EXISTS public.account_type;

CREATE TYPE public.account_type AS ENUM
    ('Client', 'Empoyee', 'Admin');

ALTER TYPE public.account_type
    OWNER TO cse340;


-- Table structure for tabe 'classification'
...
-- Update the description of the veicule "GM Hummer" substituting "small interiors" to "a huge interior"
UPDATE inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Uptade all records in the inventory table to add "/vehicles" to the middle of the file path in the inv_image and inv_thumbnail columns using a single query
UPDATE inventory
SET
